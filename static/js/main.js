...
(function ($) {
     ...
     * --------------------- */
     ...
     $('.modal1').click(function(){
        $('.overlay-bg-modal').fadeIn();
        $('.content-1-modal').fadeIn();
     });

 $('.modal2').click(function(){
        $('.overlay-bg-modal').fadeIn();
        $('.content-2-modal').fadeIn();
     });
  $('.modal3').click(function(){
        $('.overlay-bg-modal').fadeIn();
        $('.content-3-modal').fadeIn();
     });
  $('.modal4').click(function(){
        $('.overlay-bg-modal').fadeIn();
        $('.content-4-modal').fadeIn();
     });

 $('.modal5').click(function(){
        $('.overlay-bg-modal').fadeIn();
        $('.content-5-modal').fadeIn();
     });
  $('.modal6').click(function(){
        $('.overlay-bg-modal').fadeIn();
        $('.content-6-modal').fadeIn();
     });
    $('.modal7').click(function(){
        $('.overlay-bg-modal').fadeIn();
        $('.content-7-modal').fadeIn();
     });
      $('.modal8').click(function(){
        $('.overlay-bg-modal').fadeIn();
        $('.content-8-modal').fadeIn();
     });

     $('.overlay-bg-modal').click(function(){
         $('.overlay-bg-modal').fadeOut();
        $('.content-1-modal').fadeOut();
         $('.content-2-modal').fadeOut();
          $('.content-3-modal').fadeOut();
            $('.content-4-modal').fadeOut();
             $('.content-5-modal').fadeOut();
               $('.content-6-modal').fadeOut();
                 $('.content-7-modal').fadeOut();
                   $('.content-8-modal').fadeOut();
     });
