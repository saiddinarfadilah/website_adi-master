...
<head lang="en">
    ...
    <title>Asia Digital Indonesia PT - Produk Software</title>
...
<div class="stunning-header stunning-header-bg-breez">
    <div class="stunning-header-content">
        <h1 class="stunning-header-title">Produk Software</h1>
        <ul class="breadcrumbs">
            <li class="breadcrumbs-item">
                <a href="index.php">Home</a>
                <i class="seoicon-right-arrow"></i>
                <a href="product.php">Produk Software</a>
                <i class="seoicon-right-arrow"></i>
            </li>
...
<div class="container">
    <div class="row medium-padding120">
        ...
        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 mb30">
            <img src="static/img/local-seo3.jpg" alt="local-seo">
        </div>
